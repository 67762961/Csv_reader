...
Para_mode.Eonmode       = [0.1, 0.02, 0.1, 0];                         %% 开通损耗配置
Para_mode.Eoffmode      = [0.1, 0.02, 0.2, 0];                         %% 关断损耗配置
Para_mode.dvdtmode      = [90, 10, 10, 90];                            %% dvdt模式选择     额外的dvdt计算起始和结束百分比
Para_mode.didtmode      = [10, 90, 90, 10];                            %% didt模式选择     新设定didt计算起始和结束百分比
