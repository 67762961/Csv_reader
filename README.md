...
- #### 如何判断dvdt是否应该手动选择计算区间，应当怎么设置参数？
    ...
    ![dvdt手动设置区间对比](Readme/dvdt手动设置区间对比.png)   
...
- #### 何时应该开启didt上升容错，设置为多少合适？
    ...
    ![didt状态机动态区间算法对比](Readme/didt状态机动态区间算法对比.png)
    ...
    ![didt示例 启用容错前](<Readme/didt示例 启用容错对比.png>)
...
- #### Erec计算时下降容错应该怎么填？
    ...
    ![完美反向恢复损耗波形](Readme/完美反向恢复损耗波形.png)
    ...
    ![Erec神仙难救图](Readme/Erec神仙难救图.png)
