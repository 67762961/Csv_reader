...
Full_title = {'脉宽长(us)', '  CSV  ', 'Ic(A)', 'Icfix(A)', 'Idfix(A)' ,'Icmax(A)','Idmax(A)', 'Eon(mJ)', 'Eoff(mJ)', 'VceMAX(V)','VceMAX_fix(V)', 'VdMAX(V)', 'VdMAX_fix(V)', 'Vcetop(V)', 'Vcetop_fix(V)','dv/dton(V/us)','dv/dtonMIN(A/us)', 'dv/dtoff(V/us)','dv/dtoffMAX(A/us)','di/dton(A/us)', 'di/dtonMAX(A/us)','di/dtoff(A/us)','di/dtoffMIN(A/us)','Erec(mJ)', 'Prrmax(kW)', 'PrrPROMAX(kW)', 'Vgetop(V)','Vgebase(V)','Tdon(ns)', 'Trise(ns)', 'Tdoff(ns)', 'Tfall(ns)', 'I2dt_on','I2dt_off','Vgedg1max(V)', 'Vgedg1min(V)', 'Vgedg1mean(V)', 'Vgedg2max(V)', 'Vgedg2min(V)', 'Vgedg2mean(V)','I_on','I_off','Ton0', 'Toff0','Ton1', 'Toff1','Ton2', 'Toff2','T_Vcemax','T_Vdmax','Tdvdt_fs','Tdvdt_fe','Tdvdt_rs','Tdvdt_re','Tdidt_rs','Tdidt_re','Tdidt_fs','Tdidt_fe'};
titleMap('Standard') = {'脉宽长(us)', '  CSV  ', 'Ic(A)', 'Eon(mJ)', 'Eoff(mJ)', 'VceMAX(V)', 'VdMAX(V)', 'Vcetop(V)', 'dv/dtoff(V/us)', 'di/dton(A/us)', 'Erec(mJ)', 'Prrmax(kW)', 'Tdon(ns)', 'Tdoff(ns)', 'Vgedg1max(V)','Vgedg1min(V)','    ','    ','    ','    ','    '};
