...
text(time(PicStart+fix(PicLength*0.01)),Vgetop+1.3,['Vgetop=',num2str(Vgetop),'V'],'FontSize',13,'color',[0.7 0.7 0.7]);

line([time(PicStart),time(PicEnd)],[Vgebase, Vgebase], 'Color', [0.7 0.7 0.7]);
text(time(PicStart+fix(PicLength*0.01)),Vgebase-1.3,['Vgebase=',num2str(Vgebase),'V'],'FontSize',13,'color',[0.7 0.7 0.7]);
