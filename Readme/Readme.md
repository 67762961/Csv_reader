...
- #### 何时应该开启didt上升容错，设置为多少合适？
    ...
    ![didt状态机动态区间算法对比](didt状态机动态区间算法对比.png)
